...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.formatButton = QtWidgets.QPushButton(Frame)
        self.formatButton.setGeometry(QtCore.QRect(320, 310, 161, 51))
    ...
    def retranslateUi(self, Frame):
        ...
        self.formatButton.setText(_translate("Frame", "Format text"))
